...
def compute_pixels_time_edge_faster_rcnn(image_path, model, device, epsilon=1, iterations=100, target_confidence=0.25, confidence_threshold=0.5, nms_threshold=0.3):
...
def compute_pixels_time_edge_yolo(model_train, model_inf, device, image_path, image_id, epsilon=1, iterations=10, grid_size=3, target_confidence=0.25):
