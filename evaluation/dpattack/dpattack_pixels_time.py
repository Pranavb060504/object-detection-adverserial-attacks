...
def compute_pixels_time_dpattack(image_path, model, device, epsilon=1, iterations=100, grid_size=10, target_confidence=0.25, confidence_threshold=0.5, nms_threshold=0.3):
